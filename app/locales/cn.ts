...
const cn = {
  ...
  Settings: {
    ...
    ChatActionManagement: {
      ...
      SelectedTools: "已选工具",
      Tools: "个工具",
      DragHint: "拖拽工具到右侧进行添加，在右侧拖拽可调整顺序。点击工具可快速切换显示状态",
      Show: "显示",
      Hide: "隐藏",
      Hidden: "已隐藏",
      HiddenItems: "隐藏的功能",
      NoHiddenItems: "没有隐藏的功能",
      NoAvailableTools: "所有工具都已添加",
      NoSelectedTools: "拖拽工具到此处",
    },
    ChatActionOrder: {
      Title: "按钮排序",
      SubTitle: "调整聊天界面功能按钮的排列顺序",
      ManageOrder: "管理排序",
      Reset: "重置顺序",
      DragHint: "拖拽项目可以调整顺序，或使用上下箭头微调",
      Stop: "停止响应",
      ToBottom: "滚动到底部",
      Settings: "对话设置",
      ImageUpload: "图片上传",
    ...
    ChatActionVisibility: {
      Title: "聊天界面选项",
      SubTitle: "控制聊天界面底部功能按钮的显示",
      ShowHistoryCount: "历史消息数控制",
      ShowPromptLibrary: "提示词库",
      ShowMasks: "面具管理",
      ShowClearContext: "清除上下文",
      ShowQuickSwitch: "快捷切换模型",
      ShowModelSelector: "模型选择器",
      ShowImageUpload: "图片上传",
      ShowThemeSwitch: "主题切换",
      ShowPluginSelector: "插件选择器",
      ShowShortcutKey: "快捷键帮助",
      ShowMcpTools: "MCP工具",
    },
    HistoryCount: {
      Title: "附带历史消息数",
    ...
    QuickSwitchModels: {
      Title: "快捷切换模型",
      SubTitle: "选择在工具栏中可快速切换的模型，点击可在多个模型间循环切换",
    },
    CompressModel: {
      Title: "对话摘要模型",
