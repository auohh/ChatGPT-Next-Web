...
const en: LocaleType = {
  ...
  Compare: {
    ...
    AdoptedToast: (model: string) => `Adopted ${model}'s response`,
  },
  Export: {
  ...
  Settings: {
    ...
    ChatActionManagement: {
      Title: "Chat Interface Management",
      SubTitle: "Manage the visibility and order of chat interface function buttons",
      ManageActions: "Manage Buttons",
      Status: "Currently showing: ",
      Visible: " functions",
      AvailableTools: "Available Tools",
      SelectedTools: "Selected Tools",
      Tools: " tools",
      DragHint: "Drag tools to the right to add them, drag within the right panel to reorder. Click tools to quickly toggle visibility",
      Show: "Show",
      Hide: "Hide",
      Hidden: "Hidden",
      HiddenItems: "Hidden Functions",
      NoHiddenItems: "No hidden functions",
      NoAvailableTools: "All tools have been added",
      NoSelectedTools: "Drag tools here",
    },
    ChatActionOrder: {
      Title: "Button Order",
      SubTitle: "Adjust the order of chat interface function buttons",
      ManageOrder: "Manage Order",
      Reset: "Reset Order",
      DragHint: "Drag items to reorder or use arrow buttons for fine adjustment",
      Stop: "Stop Response",
      ...
      Masks: "Mask Management",
      ClearContext: "Clear Context",
      QuickSwitch: "Quick Switch",
      ModelSelector: "Model Selector",
      SizeSelector: "Image Size",
      QualitySelector: "Image Quality",
      StyleSelector: "Image Style",
      PluginSelector: "Plugin Selector",
      ShortcutKey: "Shortcut Key",
      McpTools: "MCP Tools",
    },
    ChatActionVisibility: {
      Title: "Chat Interface Options",
      SubTitle: "Control the visibility of chat interface function buttons",
      ShowHistoryCount: "History Message Count",
      ShowPromptLibrary: "Prompt Library",
      ShowMasks: "Mask Management",
      ShowClearContext: "Clear Context",
      ShowQuickSwitch: "Quick Model Switch",
      ShowModelSelector: "Model Selector",
      ShowImageUpload: "Image Upload",
      ShowThemeSwitch: "Theme Switch",
      ShowPluginSelector: "Plugin Selector",
      ShowShortcutKey: "Shortcut Key Help",
      ShowMcpTools: "MCP Tools",
    },
    HistoryCount: {
    ...
    QuickSwitchModels: {
      ...
      SubTitle: "Select models that can be quickly switched in the toolbar. Click to cycle through multiple models.",
    },
    CompressModel: {
      Title: "Summary Model",
